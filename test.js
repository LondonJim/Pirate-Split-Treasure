...
describe('SplitTreasure', () => {
  ...
  describe('#split', () => {
    ...
    // False outcome
    it('Can not split the array evenly 4 ways based on number and total of elements', () => {
      let arr = [4, 4, 4, 4, 4]

      expect(splitTreasure.split(arr, 4)).to.be.equal(false)
    })

    it('Can not split the array evenly 2 ways based on number and total of elements', () => {
      let arr = [27, 7, 20, 3]
